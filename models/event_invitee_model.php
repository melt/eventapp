...
class EventInviteeModel extends AppModel implements qmi\UserInterfaceProvider {
    /* N-N Relations */
    public $event_id = array('core\PointerType', 'EventModel');
    public $invitee_id = array('core\PointerType', 'userx\UserModel');
    ...
    public $rvsp = array('core\SelectType', array(self::ATTENDING => "Attending", self::NOT_ATTENDING => "Not Attending"));
