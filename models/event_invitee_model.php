    ...
    public static function uiGetInterface($interface_name, $field_set) {
        ...
        case "add_invitees":
            return array(
                ...
                "list_of_emails" => array(_("People to invite"), "Enter names or email addresses of people to invite separated by comma (,). Automatically searches for Sandbox members and previous guests."),
            );
            break;
