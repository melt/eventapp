...
<body id="background">
    ...
    <table id="outside-bottom" width="580">
        <tr>
            <td class="footer">
                <p>&copy; <?php echo date("Y"); ?> Sandbox Network. <?php if(isset($this->unsubscribe_link)): ?><a target="_blank" href="<?php echo $this->unsubscribe_link; ?>"><?php echo _("Click on this link"); ?></a> to unsubscribe from all future emails.<?php endif; ?>
                </p>
            </td>
            <td class="footer">
                &nbsp;
